...
class BookmarkedTableViewCell: UITableViewCell {
    ...
    @objc private func bookmarkButtonTapped() {
        updateBookmarkState(isBookmarked: isBookmarked, animated: true)
        onBookmarkTapped?()
    }
    ...
    func configure(with article: BookmarkedArticle) {
        ...
        positiveReactionView.configure(withImageName: "positive", value: Int(article.positiveReactionsCount))
        commentReactionView.configure(withImageName: "comments", value: Int(article.commentsCount))
        publicReactionView.configure(withImageName: "public_reactions", value: Int(article.publicReactionsCount))
    }
}
